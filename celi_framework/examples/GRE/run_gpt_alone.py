...
from templates.templates import make_gpt_prompt, make_gpt_prompt_simple, score_llm_prompt
...
EXAMPLE_RUBRIC_DIR = f'{ROOT_DIR}/celi_framework/examples/GRE/data/working_data/rubric'
...
def run_gpt():
    for key in ['q1','q2','q3']:
        ...
        example_prompt = load_text_file(file_path=f'{EXAMPLE_QUESTIONS_DIR}/set_1_example_q1_question.txt')
        example_response = load_text_file(file_path=f'{EXAMPLE_QUESTIONS_DIR}/set_1_example_q1_response.txt')
        example_rubric = load_text_file(file_path=f'{EXAMPLE_RUBRIC_DIR}/gre_1_scoring_guidelines.txt')
        ...
        system_message, user_prompt = score_llm_prompt(prompt=current_prompt,
